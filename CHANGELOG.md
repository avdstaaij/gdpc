...
- `nbt_tools`: Provides some low-level tools for the
  [NBT format](https://minecraft.wiki/w/NBT_format). This is mainly for
  internal use.
...
- Optional [block states](https://minecraft.wiki/w/Block_states)
  (e.g. `facing=north`).
- Optional [block entity](https://minecraft.wiki/w/Block_entity)
